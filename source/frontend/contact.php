...
<head>
    <meta charset="utf-8">
    <title>Contact Us - K9-Vets</title>
    ...
    <div class="container-fluid header bg-primary p-0 mb-5">
        <div class="row g-0 align-items-center">
            <div class="col-lg-6 p-5 wow fadeIn" data-wow-delay="0.1s">
                <h1 class="display-4 text-white mb-5">Contact Us</h1>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <h5 class="section-title bg-white text-start text-primary pe-3">Contact Us</h5>
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <div class="d-flex mb-4">
                        ...
                        <div class="ms-4">
                            <h5>Our Office</h5>
                            <p>Sanghabo Mawatha Pubudhupura, Himaka junction, Anuradhapura</p>
                        </div>
                    </div>
                    <div class="d-flex mb-4">
                        <div class="flex-shrink-0 btn-lg-square bg-primary">
